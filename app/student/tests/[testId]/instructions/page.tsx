  ...
  if (!result.success || !test) {
    return (
      <PageShell
        ...
        description="Review the test details before you start."
      >
        <div className="rounded-3xl border border-rose-200 bg-rose-50 p-6 shadow-sm">
          ...
          {result.status === 403 ? (
            <div className="mt-4 text-sm text-rose-700">
              ...
              <ul className="mt-2 ml-4 list-disc space-y-1">
                <li>
                  You are not enrolled in the batch this test belongs to
                </li>
                <li>
                  Your batch enrollment has expired or been cancelled
                </li>
                <li>
                  The batch linked to this test is currently closed
                </li>
              </ul>
              <p className="mt-3">
                Please contact your admin or check your{" "}
                <Link
          ...
          <div className="mt-5">
            <Link
              href="/student/tests"
              className="inline-flex rounded-xl border border-rose-200 bg-white px-4 py-2 text-sm font-medium text-rose-700 hover:bg-rose-50"
            >
              Back to Tests
            </Link>
          </div>
        ...
        <section className="space-y-6">
          ...
          <div className="rounded-3xl border bg-white p-6 shadow-sm">
            ...
            <ul className="mt-4 space-y-3 text-sm leading-6 text-slate-700">
              <li>
                • One attempt per student is currently allowed for each test.
              </li>
              <li>
                • If your session gets interrupted, the system is designed to
                resume the same attempt flow.
              </li>
              <li>
                • Auto-submit and final result logic are handled by the backend
                once you complete the attempt.
              </li>
              <li>
                • Start timing and live window behavior depend on the current
                real test status.
              </li>
              <li>
                • Keep your preferred language and internet connection ready
                before starting.
              </li>
            </ul>
          </div>
