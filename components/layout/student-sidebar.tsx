...
export function StudentSidebar() {
  ...
  return (
    <aside className="hidden xl:flex xl:flex-col w-64 shrink-0 fixed top-0 left-0 h-screen border-r border-slate-800 bg-slate-900 z-30">
                ...
                >
                  <span
                    className={`text-[10px] font-bold uppercase tracking-[0.12em] transition-colors ${
                      groupHasActive ? "text-blue-400" : "text-slate-500"
                    }`}
                  >
                    {group.groupLabel}
                  </span>
